            ...
            <Router>
              <div>
                <MDBNavbar dark expand="md" fixed="top">
                  <MDBContainer>
                    <MDBNavbarBrand>
                      <strong className="white-text">Blood Donation Bank</strong>
                    </MDBNavbarBrand>
                    <MDBNavbarToggler
                      onClick={this.toggleCollapse("navbarCollapse")}
                    />
...
onChange={(e) => this.setState({ bloodgroup: e.target.value })} */}
  ...
  <option value="A Negitive">A Negative</option>
  <option value="B Negitive">B Negative</option>
  <option value="O Negitive">O Negative</option>
</select>  
                            <MDBInput
                              className="white-text"
                              iconClass="white-text"
